...
#define DATE "built on: Fri Jul  3 14:09:11 2020 UTC"
...
static const char compiler_flags[] = {
    ...
    '2','4',' ','-','i','s','y','s','t','e','m',' ','/','h','o','m',
    'e','/','k','a','o','x','/','.','b','u','i','l','d','o','z','e',
